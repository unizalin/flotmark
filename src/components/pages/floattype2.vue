      ...
      <div class="col-3">
        <div id="INPUT_BOX">
          ...
          <div class="BOX_BG" :style="{borderColor:borderColor}">
            <div class="e_BT">
              <ul class="TWO">
                <li><a href="#" class="BT_COLOUR">{{left.text}}<p>({{left.price}})</p></a></li>
                <li><a href="#" class="BT_COLOUR2">{{right.text}}<p>({{right.price}})</p></a></li>
              </ul>
            </div>
...
export default {
  ...
  methods: {
    changeColor (e) {
      const heading = document.querySelector('.BT_COLOUR');
