        ...
        <div id="INPUT_BOX">
          ...
          <div class="BOX_BG" :style="{borderColor:borderColor}">
            <div class="pq_e_BT">
              <ul class="TWO">
                <li>
                  <a href="#" id="BT_COLOUR" class="pq_BT_SROUND  pq_BG_GRA_RED" >{{left.text}}<p>({{left.price| currency}})</p></a>
                </li>
                <li>
                  <a href="#" id="BT_PRICE" class="pq_BT_PRICE pq_BT_SROUND  pq_BG_GRA_RED" >{{right.text}}<p>({{right.price| currency}})</p></a>
                </li>
              </ul>
            </div>
